...
class MaskRefineDataset(torch.utils.data.Dataset):
    def __init__(self, is_train, args):
        ...
        self.augment_transform = get_transform(args, 
            additional_targets={'W':'image', 'T':'image', 'mask':'mask', 'gen_mask':'mask' }) #,
    ...
    def get_sample(self, index):
        ...
        return {'W': img_W, 'T': img_T, 'mask':mask, 'gen_mask':gen_mask, 'img_path':self.imageW_path%img_id}
